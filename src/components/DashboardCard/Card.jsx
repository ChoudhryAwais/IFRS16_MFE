...
export default function CustomCard({ card, loading }) {
    return (
        <div className="flex-1 m-1 bg-white shadow-md rounded-md p-5 text-center border border-gray-200 dark:bg-gray-800">
            <h5 className="text-sm font-semibold text-gray-700 dark:text-gray-100">{card.title}</h5>
